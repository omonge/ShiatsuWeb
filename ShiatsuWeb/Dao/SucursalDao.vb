...
Public Class SucursalDao
    ...
    Public Sub insertar(ByRef dato As Sucursal)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_sucursal  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As Sucursal)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_sucursal  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

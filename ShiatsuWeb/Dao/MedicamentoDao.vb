...
Public Class MedicamentoDao
    ...
    Public Sub insertar(ByRef dato As Medicamento)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_medicamento  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As Medicamento)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_medicamento  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

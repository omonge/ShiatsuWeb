...
Public Class ProductoDao
    ...
    Public Sub insertar(ByRef dato As Producto)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_producto  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As Producto)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_producto  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

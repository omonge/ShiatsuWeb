...
Public Class TarjetaDao
    ...
    Public Sub insertar(ByRef dato As Tarjeta)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_tarjeta  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As Tarjeta)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_tarjeta  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

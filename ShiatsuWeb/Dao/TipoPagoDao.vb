...
Public Class TipoPagoDao
    ...
    Public Sub insertar(ByRef dato As TipoPago)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_tipo_pago  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As TipoPago)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_tipo_pago  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

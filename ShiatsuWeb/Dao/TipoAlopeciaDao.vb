...
Public Class TipoAlopeciaDao


    Public Sub insertar(ByRef dato As TipoAlopecia)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_tipo_alopecia  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As TipoAlopecia)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_tipo_alopecia  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

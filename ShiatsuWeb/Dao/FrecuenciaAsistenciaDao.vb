...
Public Class FrecuenciaAsistenciaDao


    Public Sub insertar(ByRef dato As FrecuenciaAsistencia)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_frecuencia_asistencia  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As FrecuenciaAsistencia)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_frecuencia_asistencia  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

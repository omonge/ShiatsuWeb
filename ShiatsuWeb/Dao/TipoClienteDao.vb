...
Public Class TipoClienteDao
    ...
    Public Sub insertar(ByRef dato As TipoCliente)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_tipo_cliente  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As TipoCliente)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_tipo_cliente  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

...
Public Class EnfermedadDao
    ...
    Public Sub insertar(ByRef dato As Enfermedad)
        'variables
        ...
        'sql
        Dim sql As String = "INSERT INTO  cat_enfermedad  (descripcion,estado,usuario,fmodifica) VALUES (@descripcion,@estado,@usuario,@fmodifica)"
        'adapter
    ...
    Public Sub modificar(ByRef dato As Enfermedad)
        ...
        coneccion = New MySqlConnection(SuperSecreto)
        'sql
        Dim sql As String = "UPDATE  cat_enfermedad  SET  descripcion  = @descripcion,  estado  = @estado, usuario=@usuario, fmodifica=@fmodifica WHERE  id  = @id"
        'adapter
        dataAdapter = New MySqlDataAdapter()

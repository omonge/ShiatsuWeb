<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoProducto.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoProducto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_producto  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_producto  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_producto " 
        UpdateCommand="UPDATE  cat_producto  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

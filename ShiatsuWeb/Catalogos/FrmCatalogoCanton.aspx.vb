Public Class FrmCatalogoCanton
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim cantonDao As CantonDao = New CantonDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim canton As Canton = New Canton()
                canton.metId = Me.txtId.Text
                canton.metEstado = Me.ddlEstados.SelectedValue
                canton.metProvincia = CInt(Me.ddlProvincia.SelectedValue)
                canton.metDescripcion = Me.txtDescripcion.Text
                canton.metFmodifica = DateTime.Now
                canton.metUsuario = Me.usuario.usuario
                Me.cantonDao.insertar(canton)
                Me.limpiar()
    ...
    Protected Sub gvDatos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvDatos.SelectedIndexChanged
        Try
            ...
            Me.ddlProvincia.SelectedValue = Me.gvDatos.SelectedRow.Cells(4).Text.Split(" ")(0)
        Catch ex As Exception
            Me.lblMensaje.ForeColor = Drawing.Color.Red
            Me.lblMensaje.Text = "Error: " + ex.Message
        End Try

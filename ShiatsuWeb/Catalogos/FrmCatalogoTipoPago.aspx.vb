Public Class FrmCatalogoTipoPago
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim tipoPagoDao As TipoPagoDao = New TipoPagoDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim tipoPago As tipoPago = New tipoPago()
                tipoPago.metEstado = Me.ddlEstados.SelectedValue
                tipoPago.metDescripcion = Me.txtDescripcion.Text
                tipoPago.metFmodifica = DateTime.Now
                tipoPago.metUsuario = Me.usuario.usuario
                Me.tipoPagoDao.insertar(tipoPago)
                Me.limpiar()
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim tipoPago As tipoPago = New tipoPago()
                tipoPago.metId = Me.txtId.Text
                tipoPago.metEstado = Me.ddlEstados.SelectedValue
                tipoPago.metDescripcion = Me.txtDescripcion.Text
                tipoPago.metFmodifica = DateTime.Now
                tipoPago.metUsuario = Me.usuario.usuario
                Me.tipoPagoDao.modificar(tipoPago)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoEnfermedad.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoEnfermedad" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Mantenimiento Enfermedad</h3>
   <table>
        <tr>
        <td >Id</td>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_enfermedad  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_enfermedad  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_enfermedad " 
        UpdateCommand="UPDATE  cat_enfermedad  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

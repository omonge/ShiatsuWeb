...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_profesion  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_profesion  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_profesion " 
        UpdateCommand="UPDATE  cat_profesion  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

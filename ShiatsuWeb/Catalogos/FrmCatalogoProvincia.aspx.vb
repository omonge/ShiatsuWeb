Public Class FrmCatalogoProvincia
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim provinciaDao As ProvinciaDao = New ProvinciaDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                ...
                provincia.metEstado = Me.ddlEstados.SelectedValue
                provincia.metDescripcion = Me.txtDescripcion.Text
                provincia.metFmodifica = DateTime.Now
                provincia.metUsuario = Me.usuario.usuario
                Me.provinciaDao.insertar(provincia)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim provincia As Provincia = New Provincia()
                provincia.metId = Me.txtId.Text
                provincia.metEstado = Me.ddlEstados.SelectedValue
                provincia.metDescripcion = Me.txtDescripcion.Text
                provincia.metFmodifica = DateTime.Now
                provincia.metUsuario = Me.usuario.usuario
                Me.provinciaDao.modificar(provincia)

Public Class FrmCatalogoSuministro
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim suministroDao As SuministroDao = New SuministroDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim suministro As Suministro = New Suministro()

                suministro.metEstado = Me.ddlEstados.SelectedValue
                suministro.metDescripcion = Me.txtDescripcion.Text
                suministro.metFmodifica = DateTime.Now
                suministro.metUsuario = Me.usuario.usuario
                Me.suministroDao.insertar(suministro)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim suministro As Suministro = New Suministro()
                suministro.metId = Me.txtId.Text
                suministro.metEstado = Me.ddlEstados.SelectedValue
                suministro.metDescripcion = Me.txtDescripcion.Text
                suministro.metFmodifica = DateTime.Now
                suministro.metUsuario = Me.usuario.usuario
                Me.suministroDao.modificar(suministro)

Public Class FrmCatalogoDistrito
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim distritoDao As DistritoDao = New DistritoDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim distrito As Distrito = New Distrito()
                distrito.metId = Me.txtId.Text
                distrito.metEstado = Me.ddlEstados.SelectedValue
                distrito.metProvincia = CInt(Me.ddlProvincia.SelectedValue)
                distrito.metCanton = CInt(Me.ddlCanton.SelectedValue)
                distrito.metDescripcion = Me.txtDescripcion.Text
                distrito.metFmodifica = DateTime.Now
                distrito.metUsuario = Me.usuario.usuario
                Me.distritoDao.insertar(distrito)
                Me.limpiar()
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                ...
                distrito.metFmodifica = DateTime.Now
                distrito.metUsuario = Me.usuario.usuario
                Me.distritoDao.modificar(distrito)
    ...
    Protected Sub gvDatos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvDatos.SelectedIndexChanged
        Try
            ...
            Me.txtDescripcion.Text = Me.gvDatos.SelectedRow.Cells(5).Text
            Me.ddlProvincia.SelectedValue = Me.gvDatos.SelectedRow.Cells(3).Text.Split(" ")(0)
            Me.ddlCanton.SelectedValue = Me.gvDatos.SelectedRow.Cells(4).Text.Split(" ")(0)
        Catch ex As Exception
            Me.lblMensaje.ForeColor = Drawing.Color.Red
            Me.lblMensaje.Text = "Error: " + ex.Message
        End Try

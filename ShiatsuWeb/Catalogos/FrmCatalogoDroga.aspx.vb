Public Class FrmCatalogoDroga
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim drogaDao As DrogaDao = New DrogaDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim droga As Droga = New Droga()

                droga.metEstado = Me.ddlEstados.SelectedValue
                droga.metDescripcion = Me.txtDescripcion.Text
                droga.metFmodifica = DateTime.Now
                droga.metUsuario = Me.usuario.usuario
                Me.drogaDao.insertar(droga)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim droga As Droga = New Droga()
                droga.metId = Me.txtId.Text
                droga.metEstado = Me.ddlEstados.SelectedValue
                droga.metDescripcion = Me.txtDescripcion.Text
                droga.metFmodifica = DateTime.Now
                droga.metUsuario = Me.usuario.usuario
                Me.drogaDao.modificar(droga)

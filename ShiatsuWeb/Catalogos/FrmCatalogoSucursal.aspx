<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoSucursal.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoSucursal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_sucursal  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_sucursal  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_sucursal " 
        UpdateCommand="UPDATE  cat_sucursal  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

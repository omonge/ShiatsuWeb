<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoPais.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoPais" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_pais  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_pais  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_pais " 
        UpdateCommand="UPDATE  cat_pais  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

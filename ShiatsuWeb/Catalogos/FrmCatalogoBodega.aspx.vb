Public Class FrmCatalogoBodega
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim bodegaDao As BodegaDao = New BodegaDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                ...
                bodega.metEstado = Me.ddlEstados.SelectedValue
                bodega.metDescripcion = Me.txtDescripcion.Text
                bodega.metFmodifica = DateTime.Now
                bodega.metUsuario = Me.usuario.usuario
                Me.bodegaDao.insertar(bodega)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim bodega As Bodega = New Bodega()
                bodega.metId = Me.txtId.Text
                bodega.metEstado = Me.ddlEstados.SelectedValue
                bodega.metDescripcion = Me.txtDescripcion.Text
                bodega.metFmodifica = DateTime.Now
                bodega.metUsuario = Me.usuario.usuario
                Me.bodegaDao.modificar(bodega)

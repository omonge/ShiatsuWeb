Public Class FrmCatalogoTipoCliente
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim tipoClienteDao As TipoClienteDao = New TipoClienteDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim tipoCliente As TipoCliente = New TipoCliente() 
                tipoCliente.metEstado = Me.ddlEstados.SelectedValue
                tipoCliente.metDescripcion = Me.txtDescripcion.Text
                tipoCliente.metFmodifica = DateTime.Now
                tipoCliente.metUsuario = Me.usuario.usuario
                Me.tipoClienteDao.insertar(tipoCliente)
                Me.limpiar()
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim tipoCliente As TipoCliente = New TipoCliente()
                tipoCliente.metId = Me.txtId.Text
                tipoCliente.metEstado = Me.ddlEstados.SelectedValue
                tipoCliente.metDescripcion = Me.txtDescripcion.Text
                tipoCliente.metFmodifica = DateTime.Now
                tipoCliente.metUsuario = Me.usuario.usuario
                Me.tipoClienteDao.modificar(tipoCliente)

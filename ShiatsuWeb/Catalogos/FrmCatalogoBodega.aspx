<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoBodega.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoBodega" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_bodega  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_bodega  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_bodega " 
        UpdateCommand="UPDATE  cat_bodega  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

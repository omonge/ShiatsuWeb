Public Class FrmCatalogoRecargo
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim recargoDao As RecargoDao = New RecargoDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim recargo As Recargo = New Recargo()

                recargo.metEstado = Me.ddlEstados.SelectedValue
                recargo.metDescripcion = Me.txtDescripcion.Text
                recargo.metFmodifica = DateTime.Now
                recargo.metUsuario = Me.usuario.usuario
                Me.recargoDao.insertar(recargo)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim recargo As Recargo = New Recargo()
                recargo.metId = Me.txtId.Text
                recargo.metEstado = Me.ddlEstados.SelectedValue
                recargo.metDescripcion = Me.txtDescripcion.Text
                recargo.metFmodifica = DateTime.Now
                recargo.metUsuario = Me.usuario.usuario
                Me.recargoDao.modificar(recargo)

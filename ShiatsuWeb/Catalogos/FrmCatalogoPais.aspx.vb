Public Class FrmCatalogoPais
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim paisDao As PaisDao = New PaisDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                ...
                pais.metEstado = Me.ddlEstados.SelectedValue
                pais.metDescripcion = Me.txtDescripcion.Text
                pais.metFmodifica = DateTime.Now
                pais.metUsuario = Me.usuario.usuario
                Me.paisDao.insertar(pais)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim pais As Pais = New Pais()
                pais.metId = Me.txtId.Text
                pais.metEstado = Me.ddlEstados.SelectedValue
                pais.metDescripcion = Me.txtDescripcion.Text
                pais.metFmodifica = DateTime.Now
                pais.metUsuario = Me.usuario.usuario
                Me.paisDao.modificar(pais)

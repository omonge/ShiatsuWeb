<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoDroga.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoDroga" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_droga  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_droga  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_droga " 
        UpdateCommand="UPDATE  cat_droga  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

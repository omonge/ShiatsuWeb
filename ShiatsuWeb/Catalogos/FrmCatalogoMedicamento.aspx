<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoMedicamento.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoMedicamento" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_medicamento  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_medicamento  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_medicamento " 
        UpdateCommand="UPDATE  cat_medicamento  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

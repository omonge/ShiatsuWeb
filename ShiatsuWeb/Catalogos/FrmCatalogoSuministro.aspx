<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoSuministro.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoSuministro" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Mantenimiento Suministro</h3>
   <table>
        <tr>
        <td >Id</td>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_suministro  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_suministro  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_suministro " 
        UpdateCommand="UPDATE  cat_suministro  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

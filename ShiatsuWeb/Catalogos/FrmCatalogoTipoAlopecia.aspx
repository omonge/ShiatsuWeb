<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoTipoAlopecia.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoTipoAlopecia" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Mantenimiento Tipo Alopecia</h3>
   <table>
        <tr>
        <td >Id</td>
        <td >
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_tipo_alopecia  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_tipo_alopecia  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_tipo_alopecia " 
        UpdateCommand="UPDATE  cat_tipo_alopecia  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

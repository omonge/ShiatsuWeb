Public Class FrmCatalogoMedicamento
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim medicamentoDao As MedicamentoDao = New MedicamentoDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim medicamento As Medicamento = New Medicamento()

                medicamento.metEstado = Me.ddlEstados.SelectedValue
                medicamento.metDescripcion = Me.txtDescripcion.Text
                medicamento.metFmodifica = DateTime.Now
                medicamento.metUsuario = Me.usuario.usuario
                Me.medicamentoDao.insertar(medicamento)
                Me.limpiar()
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim medicamento As Medicamento = New Medicamento()
                medicamento.metId = Me.txtId.Text
                medicamento.metEstado = Me.ddlEstados.SelectedValue
                medicamento.metDescripcion = Me.txtDescripcion.Text
                medicamento.metFmodifica = DateTime.Now
                medicamento.metUsuario = Me.usuario.usuario
                Me.medicamentoDao.modificar(medicamento)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoRecargo.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoRecargo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_recargo  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_recargo  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_recargo " 
        UpdateCommand="UPDATE  cat_recargo  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

Public Class FrmCatalogoTarjeta
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim productoDao As TarjetaDao = New TarjetaDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim producto As Tarjeta = New Tarjeta()

                producto.metEstado = Me.ddlEstados.SelectedValue
                producto.metDescripcion = Me.txtDescripcion.Text
                producto.metFmodifica = DateTime.Now
                producto.metUsuario = Me.usuario.usuario
                Me.productoDao.insertar(producto)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim producto As Tarjeta = New Tarjeta()
                producto.metId = Me.txtId.Text
                producto.metEstado = Me.ddlEstados.SelectedValue
                producto.metDescripcion = Me.txtDescripcion.Text
                producto.metFmodifica = DateTime.Now
                producto.metUsuario = Me.usuario.usuario
                Me.productoDao.modificar(producto)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoProvincia.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoProvincia" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_provincia  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_provincia  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_provincia " 
        UpdateCommand="UPDATE  cat_provincia  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>

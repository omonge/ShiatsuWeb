Public Class FrmCatalogoEnfermedad
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim enfermedadDao As EnfermedadDao = New EnfermedadDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                Dim enfermedad As Enfermedad = New Enfermedad() 
                enfermedad.metEstado = Me.ddlEstados.SelectedValue
                enfermedad.metDescripcion = Me.txtDescripcion.Text
                enfermedad.metFmodifica = DateTime.Now
                enfermedad.metUsuario = Me.usuario.usuario
                Me.enfermedadDao.insertar(enfermedad)
                Me.limpiar()
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim enfermedad As Enfermedad = New Enfermedad()
                enfermedad.metId = Me.txtId.Text
                enfermedad.metEstado = Me.ddlEstados.SelectedValue
                enfermedad.metDescripcion = Me.txtDescripcion.Text
                enfermedad.metFmodifica = DateTime.Now
                enfermedad.metUsuario = Me.usuario.usuario
                Me.enfermedadDao.modificar(enfermedad)

Public Class FrmCatalogoSucursal
    Inherits System.Web.UI.Page
    Dim usuario As Usuario
    Dim sucursalDao As SucursalDao = New SucursalDao()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            If (Me.validar()) Then
                ...
                sucursal.metEstado = Me.ddlEstados.SelectedValue
                sucursal.metDescripcion = Me.txtDescripcion.Text
                sucursal.metFmodifica = DateTime.Now
                sucursal.metUsuario = Me.usuario.usuario
                Me.sucursalDao.insertar(sucursal)
                Me.limpiar() 
    ...
    Protected Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            ...
            If (Me.validar()) Then
                Dim sucursal As Sucursal = New Sucursal()
                sucursal.metId = Me.txtId.Text
                sucursal.metEstado = Me.ddlEstados.SelectedValue
                sucursal.metDescripcion = Me.txtDescripcion.Text
                sucursal.metFmodifica = DateTime.Now
                sucursal.metUsuario = Me.usuario.usuario
                Me.sucursalDao.modificar(sucursal)

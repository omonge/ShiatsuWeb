<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmCatalogoTarjeta.aspx.vb" Inherits="ShiatsuWeb.FrmCatalogoTarjeta" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table>
    ...
    <asp:SqlDataSource ID="frenciasDS" runat="server" 
        ...
        DeleteCommand="DELETE FROM  cat_tarjeta  WHERE  id  = ?" 
        InsertCommand="INSERT INTO  cat_tarjeta  ( id ,  estado , descripcion ) VALUES (?, ?, ?)" 
        SelectCommand="SELECT  id ,  estado ,  descripcion,usuario,fmodifica  FROM  cat_tarjeta " 
        UpdateCommand="UPDATE  cat_tarjeta  SET  estado  = ?,  descripcion  = ? WHERE  id  = ?">
        <DeleteParameters>
